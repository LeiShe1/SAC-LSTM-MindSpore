...
parser.add_argument('--data_test_path', type=str, default="/home/ma-user/work/CIKM_dataset/debug_test.txt")
# model
...
def wrapper_test(model):
    ...
    test_dataloader = x2ms_datasets.DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=1,drop_last=True)
