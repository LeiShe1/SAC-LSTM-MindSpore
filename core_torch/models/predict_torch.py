...
from core_torch.layers.LSTMCell import LSTMCell
from core_torch.layers.ST_LSTMCell import SpatioTemporalLSTMCell
from core_torch.layers.CausalLSTMCell import CausalLSTMCell
from core_torch.layers.GradientHighwayUnit import GHU

from core_torch.layers.InterLSTMCell import InterLSTMCell
from core_torch.layers.InterST_LSTMCell import InterSpatioTemporalLSTMCell
from core_torch.layers.InteractCausalLSTMCell import InteractCausalLSTMCell

from core_torch.layers.CST_LSTMCell import CST_LSTMCell
from core_torch.layers.SST_LSTMCell import SST_LSTMCell
from core_torch.layers.DST_LSTMCell import DST_LSTMCell
from core_torch.layers.InterDST_LSTMCell import InterDST_LSTMCell
...
class PredRNN_Plus(nn.Module):
    ...
    def forward(self, frames, mask_true, is_training=True):
        ...
        for i in range(self.num_layers):
            ...
            h_t.append(zeros)
            c_t.append(zeros)
        memory = torch.zeros([batch, self.num_hidden[-1], height, width])
