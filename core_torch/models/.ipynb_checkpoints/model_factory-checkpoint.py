...
from core_torch.models import predict
from core_torch.layers.Discriminator import Discriminatorr
...
class Model(object):
    ...
    def load(self):
        ...
        # for k in self.network.parameters():
        #     print(k.shape)
    ...
    def train(self, frames, mask):
        ...
        # # loss = loss_l1 + loss_l2 + 0.001*loss_features + 0.0001*gen_D_loss  #reexp_227
        # # loss = loss_l1 + loss_l2 + 0.0001*loss_features + 0.00001*gen_D_loss  #reexp_33
        # loss = loss_l1 + loss_l2 + 0.01*loss_features + 0.001*gen_D_loss    #reexp_39
        # loss.backward()
        # self.optimizer.step()
        # return loss.detach().cpu().numpy()
